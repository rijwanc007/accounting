...
@section('content')
    <div class="row">
        <div class="col-md-12 text-right">
            <a class="main_head_button" href="{{route('sub_sub__head.create')}}">Create Sub Sub Head</a>
        </div>
        ...
        <div class="col-md-6">
            ...
            <form class="d-flex" action="#">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control bg-transparent border-0" placeholder="Search Sub Sub Head">
                </div>
            </form>
        </div>
        <div class="col-md-3"></div>
