@extends('master')
@section('account','active') @section('account-show','show') @section('vouchar','active') @section('vouchar-show','show') @section('journal','active') @section('journal-show','show') @section('journal-create','active')
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => 'journal.store','method' => 'POST']) !!}
    <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-10">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2"><i class="mdi mdi-plus"></i></span> Add New Journal Voucher</h3></div>
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-4"><div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="voucher_no" name="voucher_no" value="JV {{$journals->count() + 1}}" readonly required>
                                    </div></div>
                                <div class="col-md-4"><div class="form-group">
    ...
    <script type="text/javascript">
        ...
        $(document).on('input', '.debit_test', function (){
           //  let html = '';
           //  html += '<select class="form-control selectpicker debit_test" data-live-search="true" name="debit" id="debit" >\n' +
           //      '<option value="" selected disabled>Choose An option</option>\n' +
           //      '</select>';
