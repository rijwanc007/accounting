...
@section('content')
    {!! Form::open(['class' =>'form-sample','route' => ['debit_voucher.update', $edit->id],'method' => 'PATCH']) !!}
    <div class="row">
        <div class="col-md-1"></div>
        <div class="col-md-10">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-success text-white mr-2"><i class="mdi mdi-pencil"></i></span> Debit Voucher</h3></div>
            <div class="card">
                <div class="card-body">
                    <div class="row">
